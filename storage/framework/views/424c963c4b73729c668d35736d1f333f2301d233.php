...
<head>
    ...
    <title>
        <?php echo $__env->yieldContent('title','ShopRun!'); ?>
    </title>
   ...
   <link href="<?php echo e(asset('dist/font/times-new-roman-italic-58a6bd2ca8eaa.ttf')); ?>">
...
<script src="<?php echo e(asset('dist/js/vendor/app.js')); ?>"></script>
